...
extern UTILITY_API void set_debug_flag(int flag);
extern UTILITY_API int dbg(const char * filename, const char *msg, ...);
extern UTILITY_API int mylog(const char * filename, int lvl, const char *msg, ...);
extern UTILITY_API int mylog3(FILE * fp, int lvl, const char *msg, ...);
